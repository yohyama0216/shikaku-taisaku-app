...
export default function StatsPage() {
  ...
  const totalIncorrect = examQuestions.reduce((sum, q) => sum + (progress[q.id]?.incorrectCount || 0), 0);
    ...
    <main>
      <div className="row">
        <div className="col-12">
          <h1 className="mb-4">{getExamName(examType)} - 学習統計</h1>
        </div>
      </div>
        ...
        <div className="col-md-3 col-sm-6 mb-3">
          <div className="card text-center">
            <div className="card-body">
              ...
              <small className="text-muted">/ {examQuestions.length}問</small>
            </div>
          </div>
        </div>
        <div className="col-md-3 col-sm-6 mb-3">
      ...
      <div className="row mb-4">
        ...
        <div className="col-md-4 mb-3">
          <Link href={`/${examSlug}`} className="btn btn-secondary btn-lg w-100">
            試験ページに戻る
          </Link>
        </div>
        <div className="col-md-4 mb-3">
