        ...
        <div className="col-md-3 col-sm-6 mb-3">
          <div className="card text-center">
            <div className="card-body">
              <h5 className="card-title text-muted">回答した問題数</h5>
      ...
      <div className="row mb-4">
        <div className="col-12">
          <div className="alert alert-info">
            <h5 className="alert-heading">マスターした問題</h5>
            <p className="mb-0">
              4回以上正解した問題: <strong>{masteredQuestions}</strong> 問
              {masteredQuestions > 0 && ' （これらの問題は出題されません）'}
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="table-responsive">
            <table className="table table-striped">
              <thead>
                <tr>
                  <th>カテゴリ</th>
                  <th className="text-center">回答済</th>
              ...
              {incorrectQuestions.map(({ question, progress }) => (
                <div key={question.id} className="list-group-item">
                  ...
                  <small className="text-muted">
                    <strong>正解:</strong> {question.choices[question.correctAnswer]}
                  </small>
                </div>
              ))}
            </div>
